...
**PLEASE NOTE** : due to a minor minifi bug, comment out line `systemctl start minifi` in `setup.sh`, [here](https://github.com/fabiog1901/OneNodeCDHCluster/blob/master/setup.sh#L166), before running `setup.sh`. You will be prompted to start minifi in Lab 5e.
